...
namespace ODataWithCustomResponse
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ODataWithCustomResponseContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("ODataWithCustomResponseContext")));
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ODataWithCustomResponse v1"));
            }
